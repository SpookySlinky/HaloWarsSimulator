...
class RuntimeBuildingBlocks:
    ...
    Args:
        resource_manager (ResourceManager): fill in later
    ...
    def _build_order_helper(self, build_request_result: BuildResult, base: Base, order: Orders) -> BuildOrderResults:
        ...
        :param slot: SlotNumbers: The slot that is attempting ot be built on
        ...
        if build_request_result == BuildResult.NOT_ENOUGH_RESOURCES:
            # Check to ensure there are supply pads to actually make more supplies, or atleast one is being built. If
