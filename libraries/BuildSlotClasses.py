...
class BuildSlot(ABC):
    ...
    Args:
        build_slot (str): Corresponding build slot string/number identification/base position location
    ...
    """
    def __init__(self, resource_manager: ResourceManager, build_slot: str, print_mode: bool = True):
