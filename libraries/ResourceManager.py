...
class ResourceManager:
    ...
    def is_supply_pad_built_or_being_built(self) -> bool:
        ...
        :return: Bool: true i fa supply pad is built or being built. False if otherwise
        """
    ...
    def subtract_money(self, amount: int) -> bool:
        ...
        :return: bool: True if have enough money and the subtraction has bene made. False if the subtraction cannot be
            made
        """
    ...
    def add_temple(self):
        """
        Add a temnple count. Note this is different from tech leve, as a temple can be being built, but a temple doesnt
    ...
    def update(self) -> str:
        ...
        self.current_money = self.current_money + final_rate
